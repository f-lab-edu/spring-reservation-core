...
public enum SlotErrorCode implements ErrorCode {
    SLOT_NOT_RESERVABLE("S001", "예약할 수 없습니다.", HttpStatus.CONFLICT.value()),
    SLOT_ALREADY_FULL("S002", "슬롯이 이미 꽉 찼습니다.", HttpStatus.CONFLICT.value()),
    SLOT_NOT_FOUND("S003", "슬롯을 찾을 수 없습니다.", HttpStatus.NOT_FOUND.value());
